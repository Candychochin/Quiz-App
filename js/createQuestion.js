...
document.addEventListener('DOMContentLoaded' , () => {
    ...
    createSubmitBtn.addEventListener('click' , () => {
        ...
        if ( !createAnswerInputOne.value || !createAnswerInputTwo.value || !createAnswerInputThree.value) {
            alert('Please fill in all answer fields.');
            return;
        }
        
        if ( !createCorrectRadioOne.checked && !createCorrectRadioTwo.checked && !createAnswerInputThree.checked){
